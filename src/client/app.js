...
export default function App() {
    ...
    const [ activitiesList, setActivitiesList ] = React.useState( [
        ...
        },
        {
            ...
            description: "Want to tickle da fishies ? Yaaa'r all welcome aboard !",
            locality: "Liège",
            validity: 1551474159890
        },
        {
            ...
            description: "A KeyForge Call of the Archons open tournament every friday. Get prizes!",
            locality: "Liège",
            validity: 1551474159890
        }
    ] );
    ...
    if ( status === "lonely" ) {
        return (
            <div className="main">
                <button onClick={ () => matchWithRandoms() }>Find me some friends!</button>
            </div>
        );
    } else {
        return (
